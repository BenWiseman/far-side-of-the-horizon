...
#   "| IO, m_3 = 0 | (49.08,49.84,0)  | 98.9 meV | 18.2-48.2 meV |"
NH_SUM = 58.8     # meV -- normal ordering, m1 = 0 -- the framework's live prediction
IH_SUM = 98.9     # meV -- inverted ordering, m3 = 0 -- excluded (see bound below)
...
rows1 = [("NH, m&#8321;=0 (exact-rule sector): 58.8 meV", BLUE, None),
         ("IH, m&#8323;=0 (exact-rule sector): 98.9 meV", RED, None),
