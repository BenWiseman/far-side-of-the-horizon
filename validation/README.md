...
| `free_tt_controls.txt` | `python calc/free_tt_controls.py` | Exit 0; rewrites `calc/free_tt_controls.json` byte for byte |
| `weak_yukawa_benchmark.txt` | `python calc/weak_yukawa_benchmark.py` | Exit 0; rewrites `calc/weak_yukawa_benchmark.json` byte for byte |
| `figure5_audit.txt` | `python calc/audit_fig5_redesign.py` | Exit 0 |
| `supp_figures_audit.txt` | `python calc/audit_supp_figures_v3.py` | Exit 0 |
...
`python beyond/push/P2_NUR_DM/bft_reproduce.py` also exits 0 and gives
...
`python build_pdfs.py` builds all four PDFs: main 29 pages (browser) and 30 (XeLaTeX),
